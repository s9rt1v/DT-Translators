...
The first dataset about Amazon product information was collected from Standford Network Analysis Project(SNAP) while the second dataset about transactions was generated by us during the project. 
