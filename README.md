...
The first dataset about Amazon product information amazon_reduced.csv was collected from Standford Network Analysis Project(SNAP) while the second dataset about transactions was generated by us during the project. Please make sure your graph model is created after 'SET search_path TO ag_catalog;'. 
